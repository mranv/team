        ...
        >
          {hoveredIndex === item.id && (
            <motion.div
              ...
              className="absolute -top-16 -left-1/2 translate-x-1/2 flex text-base flex-col items-center justify-center rounded-md bg-black z-50 shadow-xl px-4 py-2"
            >
              ...
              <div className="text-white text-base">{item.designation}</div>
            </motion.div>
          )}
          <Image
